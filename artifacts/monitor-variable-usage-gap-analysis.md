...
- `sw_rx_bytes`: monitor-emitted telemetry field. **Usefulness:** Low / other
...
- Section 5 lists legacy type/event keys still probed for historical `host_data`; retired KNL/MIC collectors are not in current monitor emission.
