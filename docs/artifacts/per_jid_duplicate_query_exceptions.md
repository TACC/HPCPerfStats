...
- Location: `hpcperfstats/site/lib/machine/job_detail_artifacts.py`
...
- Location: `hpcperfstats/analysis/metrics/lib/plot/*` through `persist_job_plot_artifacts_for_jid`
