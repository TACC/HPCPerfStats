...
static const struct {
  ...
  const char *key;
    ...
    /* BeeGFS ctl-derived I/O/metadata (capacity fs_* stays fast). */
    {"beegfs_client", "vfs_read_ops"},
    {"beegfs_client", "vfs_write_ops"},
    {"beegfs_client", "vfs_read_bytes"},
    {"beegfs_client", "vfs_write_bytes"},
    {"beegfs_client", "vfs_open_ops"},
    {"beegfs_client", "vfs_close_ops"},
    {"beegfs_client", "vfs_getattr_ops"},
    {"beegfs_client", "vfs_setattr_ops"},
    {"beegfs_client", "vfs_truncate_ops"},
    {"beegfs_client", "vfs_readdir_ops"},
    {"beegfs_client", "vfs_create_ops"},
    {"beegfs_client", "vfs_mkdir_ops"},
    {"beegfs_client", "vfs_rmdir_ops"},
    {"beegfs_client", "vfs_rename_ops"},
    {"beegfs_client", "vfs_unlink_ops"},
    {"beegfs_client", "vfs_link_ops"},
    {"beegfs_client", "vfs_statfs_ops"},
