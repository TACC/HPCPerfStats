...
| **`sync_ingest_current_proximity_days`** | **`2`** | CLI ``all`` exits when next pending day is within this many calendar days of a fresh ``current`` heartbeat |
