...
the Vitest suite at ``hpcperfstats/site/frontend/src/views/__tests__/JobList.test.tsx``
(including column order after Project: nodes, cores, then runtime as HH:MM:SS).
