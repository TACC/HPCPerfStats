...
HPCPERFSTATS_ROUTER_ENTRIES: list[RouterEntry] = [
    {
        ...
        "rules": [
            ...
            "sync-timedb-queue-orchestrator-contract.mdc",
            "sync-timedb-no-timers.mdc",
    ...
    {
        "id": "sync_timedb_queue_orchestrator",
        "patterns": [
            "hpcperfstats/dbload/lib/sync_timedb_queue_orchestrator.py",
            "hpcperfstats/dbload/lib/sync_timedb_archive_dir_lock.py",
            "hpcperfstats/dbload/lib/sync_timedb_job_queue.py",
            "hpcperfstats/dbload/lib/sync_timedb_job_reconstruct.py",
            "hpcperfstats/dbload/lib/sync_timedb_job_discover.py",
...
MONITOR_ROUTER_ENTRIES: list[RouterEntry] = [
    ...
    },
    {
        ...
        "patterns": [
            ...
            "HPCPerfStats/monitor/src/opa.c",
            "HPCPerfStats/monitor/src/opa_mad_*.c",
