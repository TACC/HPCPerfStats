...
Attributes:
  ...
  _HOST_ITIMES_CACHE_LOCK: FT-safe RLock for host itimes L1 cache.
  ...
  _HOST_SECOND_PRESENT_CACHE_LOCK: FT-safe RLock for second-present L1 cache.
...
_ITIMES_TIMEOUT_WARNED_LOCK = threading.RLock()
...
def reset_host_itimes_caches() -> None:
  ...
  with _ITIMES_TIMEOUT_WARNED_LOCK:
