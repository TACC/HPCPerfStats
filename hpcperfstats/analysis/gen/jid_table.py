...
class jid_table:
    ...
    def __init__(self, jid):
        ...
        self.start_time = acct_data["start_time"].dt.tz_localize('UTC').dt.tz_convert(local_timezone).values[0]
        self.end_time = acct_data["end_time"].dt.tz_localize('UTC').dt.tz_convert(local_timezone).values[0]
