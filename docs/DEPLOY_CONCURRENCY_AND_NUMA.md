...
| `sync_pool_stall_abort_after_timeouts` | 2881 | **Maximum** consecutive timeouts before exit **124** (ceiling; per-batch abort is dynamic from largest file, clamped to this × `sync_pool_poll_timeout_s`) |
