...
#define KEYS                                                                                       \
  X(excessive_buffer_overrun_errors, "E,W=32", ""),                                                \
      ...
      X(symbol_error, "E,W=32", "minor link errors"), X(port_select, "c", ""),                     \
      X(counter_select, "c", ""), X(port_xmit_pkts, "E", ""), X(port_rcv_pkts, "E", ""),           \
      X(port_unicast_xmit_pkts, "E", ""), X(port_unicast_rcv_pkts, "E", ""),                       \
      X(port_multicast_xmit_pkts, "E", ""), X(port_multicast_rcv_pkts, "E", ""),                   \
      X(sw_rx_bytes, "E,U=4B", ""), X(sw_rx_packets, "E", ""), X(sw_tx_bytes, "E,U=4B", ""),       \
      X(sw_tx_packets, "E", "")
