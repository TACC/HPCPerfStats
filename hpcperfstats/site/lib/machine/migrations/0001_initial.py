...
import hpcperfstats.site.lib.machine.models
  ...
  operations = [
      migrations.CreateModel(
          ...
          fields=[
              ...
              ('value', hpcperfstats.site.lib.machine.models.RealField(null=True)),
              ('arc', hpcperfstats.site.lib.machine.models.RealField(null=True)),
              ('delta', hpcperfstats.site.lib.machine.models.RealField(null=True)),
          ],
          options={
              'db_table': 'host_data',
          },
      ...
      migrations.AddIndex(
          ...
          index=models.Index(fields=['host', 'time'],
                             name='host_data_host_eda1c8_idx'),
      ),
      migrations.AddIndex(
          model_name='host_data',
          index=models.Index(fields=['jid', 'time'],
                             name='host_data_jid_9e84c4_idx'),
      ),
