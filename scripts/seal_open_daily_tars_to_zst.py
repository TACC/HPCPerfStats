...
Member classification and sealing use local GNU ``tar tvf`` + streamed
``zstd`` scans only (same as offline filesystem truth). The members store
is not required for this offline operator path.
