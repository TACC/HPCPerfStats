...
@patch("hpcperfstats.site.machine.api._require_auth", return_value=None)
@patch("hpcperfstats.site.machine.api._resolve_job_list_filter_options")
@patch("hpcperfstats.site.machine.api._build_job_list_queryset_from_request")
