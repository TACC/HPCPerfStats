...
def type_detail(request, jid, type_name):
    ...
    start_time = acct_data["start_time"].dt.tz_localize('UTC').dt.tz_convert(local_timezone).values[0]
    end_time = acct_data["end_time"].dt.tz_localize('UTC').dt.tz_convert(local_timezone).values[0]
