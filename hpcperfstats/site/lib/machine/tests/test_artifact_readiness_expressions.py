...
from hpcperfstats.dbload.lib.conf_parser import get_host_name_ext
...
from hpcperfstats.site.lib.machine.job_detail_artifacts import compute_detail_input_fingerprint
