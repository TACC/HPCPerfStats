/*
 * Central registry of struct stats_type pointers, lexicographically sorted by
 * st_name for stats_type_get(). Optional entries mirror configure flags and
 * src/Makefile.am TYPES (see comments in configure.ac).
 */
